...
import type { ChecklistItem as _ChecklistItem, ExternalBlob as _ExternalBlob, Submission as _Submission, Time as _Time, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getSubmission(arg0: Principal): Promise<Submission> {
        if (this.processError) {
            try {
                const result = await this.actor.getSubmission(arg0);
                return from_candid_Submission_n9(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async submitChecklist(arg0: string, arg1: Array<ChecklistItem>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitChecklist(arg0, await to_candid_vec_n16(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_ChecklistItem_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ChecklistItem): Promise<ChecklistItem> {
...
async function from_candid_Submission_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Submission): Promise<Submission> {
...
async function from_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        items: await from_candid_vec_n11(_uploadFile, _downloadFile, value.items)
    };
}
...
async function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ChecklistItem>): Promise<Array<ChecklistItem>> {
    return await Promise.all(value.map(async (x)=>await from_candid_ChecklistItem_n12(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Submission>): Promise<Array<Submission>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Submission_n9(_uploadFile, _downloadFile, x)));
}
async function to_candid_ChecklistItem_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ChecklistItem): Promise<_ChecklistItem> {
...
async function to_candid_record_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        name: value.name,
        completed: value.completed,
        photo: value.photo ? candid_some(await to_candid_ExternalBlob_n19(_uploadFile, _downloadFile, value.photo)) : candid_none()
    };
}
...
async function to_candid_vec_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<ChecklistItem>): Promise<Array<_ChecklistItem>> {
    return await Promise.all(value.map(async (x)=>await to_candid_ChecklistItem_n17(_uploadFile, _downloadFile, x)));
}
